...
- **Direct reduction**: If not using T-trade, use reduce_long to sell and close, price should be **at or above current price** for better execution price (e.g., current $41.36, set $41.40 or $41.45)
...
- **Price setting**: reduce_short is buying to close, set price **at or below current price** for better execution price (e.g., current $41.36, set $41.30 or $41.35)
