...
- reduce_position: 平仓/减仓指定数量的持仓，需要指定side（"long"减多仓/"short"减空仓）和quantity
- cancel_order: 取消指定订单
...
- reduce_position: Close/reduce position, requires side ("long" for long position / "short" for short position) and quantity
