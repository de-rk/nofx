...
export const translations = {
  en: {
    ...
    scanIntervalRecommend: '0 = disable timer (WS-only); recommended: trigger 5m → 10, trigger 15m → 20',
  ...
  zh: {
    ...
    scanIntervalRecommend: '0 = 禁用定时兜底（仅 WS 事件触发）；建议：触发周期 5m → 10，触发周期 15m → 20',
    useTestnet: '使用测试网',
    enabled: '启用',
    save: '保存',
